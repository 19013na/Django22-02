...
class TestView(TestCase):   #class 만듦. class 이름은 시작 대문자
    ...
    def test_post_list(self):
        ...
        # response 결과가 정상적인지
        self.assertEqual(response.status_code, 200) # url가져올때마다 test해줘야함.
    ...
    def test_post_detail(self):
        # 처음 시작할 때는 아무런 페이지 없이 시작. 페이지 하나 이상 있어야 들어갈 수 있음.
        post_001 = Post.objects.create(title="첫번째 포스트", content="첫번째 포스트입니다.")
